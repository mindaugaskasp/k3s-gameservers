...
read-player-db:
	@db=$$($(PLAYER_DATABASE_EXEC) node -p 'require("/app/game-status-metrics/config").PLAYERS_DATABASE_FILE') \
...
reset-player-stats:
	...
	$(PLAYER_DATABASE_EXEC) node /app/game-status-metrics/reset-player-stats.js
